...
/**
 * Defines the messaging protocol used withiin the Distributed Storage
 * System. Contains static variables for each of the different message
 * headers that can be sent within the system.
 */
